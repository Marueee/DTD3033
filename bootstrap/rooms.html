        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">La Passion</h2>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+6010-8015631</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">LaPassion@hotel.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
