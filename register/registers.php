...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        // Insert new user
        $query = "INSERT INTO users (username, password, name, phone, role) VALUES ('$username', '$password', '$name', '$phone', '$role')";
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone" name="phone" placeholder="Enter your phone number" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
