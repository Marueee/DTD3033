				...
				<div class="container">
					<div class="row no-gutters slider-text align-items-center justify-content-end">
						<div class="col-md-6 ftco-animate">
							<div class="text">
								<h2>Welcome Admin</h2>
								<h1 class="mb-3">Manage Your Booking Efficiently</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row d-flex">
				<div class="col-md pr-md-1 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services py-4 d-block text-center">
						...
						<div class="media-body">
							<h3 class="heading mb-3"><a href="view-booking.php"><span class="flaticon-add"></span> View Bookings</a></h3>
						</div>
					</div>
				</div>
				<div class="col-md px-md-1 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services py-4 d-block text-center">
						...
						<div class="media-body">
							<h3 class="heading mb-3"><a href="edit-booking.php"><span class="flaticon-edit"></span> Edit Bookings</a></h3>
						</div>
					</div>
				</div>
			</div>
